const DB_NAME = 'textbox-generator-font-library';
const DB_VERSION = 1;
...
export async function persistFontLibraryToIndexedDb(store, { indexedDb = window.indexedDB } = {}) {
...
export async function restoreFontLibraryFromIndexedDb({ indexedDb = window.indexedDB } = {}) {
